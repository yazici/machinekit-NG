...
static inline void hm2_7i90_epp_addr8(u8 addr, hm2_7i90_t *board) {
    outb(addr, board->port.base + HM2_7I90_EPP_ADDRESS_OFFSET);
    LL_PRINT_IF(debug_epp, "selected address 0x%02X\n", addr);
}

static inline void hm2_7i90_epp_addr16(u16 addr, hm2_7i90_t *board) {
...
static inline u32 hm2_7i90_epp_read32(hm2_7i90_t *board) {
    __u32 data;
...
static inline void hm2_7i90_epp_write32(__u32 w, hm2_7i90_t *board) {
    if (board->epp_wide) {
...
static inline __u8 hm2_7i90_epp_read_status(hm2_7i90_t *board) {
    __u8 val;
...
static inline void hm2_7i90_epp_write_status(__u8 status_byte, hm2_7i90_t *board) {
    outb(status_byte, board->port.base + HM2_7I90_EPP_STATUS_OFFSET);
    LL_PRINT_IF(debug_epp, "wrote status 0x%02X\n", status_byte);
}

static inline void hm2_7i90_epp_write_control(__u8 control_byte, hm2_7i90_t *board) {
